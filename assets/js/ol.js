...
(function (root, factory) {
    ...
    return function (e, f, g) {
      if (void 0 !== e)
        return (
          (e = Math.max(
            Math.floor(
              Math.log(c / e) / Math.log(a) + (0 < g ? 0 : 0 > g ? 1 : 0.5)
            ) + f,
            0
          )),
  ...
  function jb(a) {
    var c = (2 * Math.PI) / a;
    return function (a, e) {
      if (void 0 !== a) return (a = Math.floor((a + e) / c + 0.5) * c);
    };
  }
  function kb() {
    var a = Pa(5);
  ...
  function C(a, c, d, e, f) {
    ...
    (g = tb(h, d, e, !1))
      ? f || (g.ig = !1)
      : ((g = { gg: e, ig: !!f, listener: d, target: a, type: c }),
        a.addEventListener(c, rb(g)),
        h.push(g));
    return g;
  }
  function xb(a, c, d, e) {
  ...
  Fb.prototype.removeEventListener = function (a, c) {
    ...
    if (d) {
      ...
      a in this.Fa
        ? ((d[e] = ta), ++this.Fa[a])
        : (d.splice(e, 1), 0 === d.length && delete this.va[a]);
    }
  };
  function Hb() {
    Fb.call(this);
  ...
  y(Hb, Fb);
  function Ib(a) {
    if (Array.isArray(a)) for (var c = 0, d = a.length; c < d; ++c) sb(a[c]);
    else sb(a);
  }
  l = Hb.prototype;
  l.u = function () {
  ...
  l.set = function (a, c, d) {
    d
      ? (this.U[a] = c)
      : ((d = this.U[a]), (this.U[a] = c), d !== c && Nb(this, a, d));
  };
  l.C = function (a, c) {
  ...
  function Ub(a, c, d) {
    return a
      ? c.replace("{x}", a[0].toFixed(d)).replace("{y}", a[1].toFixed(d))
      : "";
  }
  function Vb(a, c) {
  ...
  "undefined" == typeof Float32Array &&
    ...
    ($b.prototype.BYTES_PER_ELEMENT = $b.prototype.BYTES_PER_ELEMENT),
    ($b.prototype.set = $b.prototype.set),
    ($b.prototype.toString = $b.prototype.toString),
    u("Float32Array", $b, void 0));
  function ac(a) {
    this.length = a.length || a;
    for (var c = 0; c < this.length; c++) this[c] = a[c] || 0;
  }
  ...
  function jc(a, c) {
    ...
    0 != Ka &&
      ((Ka = 1 / Ka),
      (c[0] = (k * Aa - m * Ta + n * oa) * Ka),
      (c[1] = (-e * Aa + f * Ta - g * oa) * Ka),
      (c[2] = (w * Y - A * M + D * K) * Ka),
      (c[3] = (-q * Y + r * M - t * K) * Ka),
      (c[4] = (-h * Aa + m * ba - n * I) * Ka),
      (c[5] = (d * Aa - f * ba + g * I) * Ka),
      (c[6] = (-v * Y + A * J - D * B) * Ka),
      (c[7] = (p * Y - r * J + t * B) * Ka),
      (c[8] = (h * Ta - k * ba + n * Ja) * Ka),
      (c[9] = (-d * Ta + e * ba - g * Ja) * Ka),
      (c[10] = (v * M - w * J + D * z) * Ka),
      (c[11] = (-p * M + q * J - t * z) * Ka),
      (c[12] = (-h * oa + k * I - m * Ja) * Ka),
      (c[13] = (d * oa - e * I + f * Ja) * Ka),
      (c[14] = (-v * K + w * B - A * z) * Ka),
      (c[15] = (p * K - q * B + r * z) * Ka));
  }
  function kc(a, c, d) {
  ...
  function rc(a, c) {
    return c
      ? ((c[0] = a[0]), (c[1] = a[1]), (c[2] = a[2]), (c[3] = a[3]), c)
      : a.slice();
  }
  function sc(a, c, d) {
  ...
  */
        ...
        for (var g in c)
          (c = e.defs(g)),
            void 0 !== c &&
              ...
              c === f
                ? bd([a, this])
                : ((c = e(g, d)), cd(a, this, c.forward, c.inverse)));
      }
    }
  }
  l = Yc.prototype;
  ...
  function pd(a) {
    return function (c, d, e) {
      ...
      for (h = 0; h < f; h += e)
        for (
          g = a([c[h], c[h + 1]]), d[h] = g[0], d[h + 1] = g[1], g = e - 1;
          2 <= g;
          --g
        )
          d[h + g] = c[h + g];
    ...
    for (n = d.length; m < n; ++m) {
      ...
      a: {
        ...
        if (c != r) {
          ...
          do
            if (
              ((z = v * Math.round(q[c] / v)),
              (B = v * Math.round(q[c + 1] / v)),
              (c += t),
              c == r)
            ) {
              w[h++] = z;
  ...
  l.ub = function (a, c, d, e) {
    ...
    this.i != this.g &&
      ((this.l = Math.sqrt(Ed(this.v, 0, this.v.length, this.a, 0))),
      (this.i = this.g));
  ...
  l.ma = function (a, c) {
    a
      ? (Ad(this, c, a, 1),
        this.v || (this.v = []),
        (this.v.length = Jd(this.v, 0, a, this.a)),
        this.u())
      : Qd(this, "XY", null);
  };
  function Qd(a, c, d) {
  ...
  l.ub = function (a, c, d, e) {
    if (e < sc(this.G(), a, c)) return e;
    this.D != this.g &&
      ((this.S = Math.sqrt(Fd(this.v, 0, this.i, this.a, 0))),
      (this.D = this.g));
  ...
  l.Z = function (a) {
    var c;
    void 0 !== a
      ? ((c = this.Mb().slice()), $d(c, 0, this.i, this.a, a))
      : (c = this.v);
  ...
  l.Mb = function () {
    if (this.T != this.g) {
      ...
      Zd(a, this.i, this.a)
        ? (this.l = a)
        : ((this.l = a.slice()),
          (this.l.length = $d(this.l, 0, this.i, this.a)));
      this.T = this.g;
    }
    return this.l;
  };
  ...
  function ee(a, c, d) {
    ...
    c = a.f;
    for (
      var g = new F(null, c), e = f * (e + 1), f = Array(e), h = 0;
      h < e;
      h++
    )
      f[h] = 0;
  ...
  function ge(a) {
    ...
    if (void 0 !== a.resolutions)
      ...
      f = e.G();
      var k =
          (f ? Math.max(Lc(f), Mc(f)) : (360 * Xc.degrees) / e.Xb()) /
          256 /
          Math.pow(2, 0),
        m = k / Math.pow(2, 28);
      e = a.maxResolution;
    ...
    (void 0 !== a.enableRotation ? a.enableRotation : 1)
      ? ((e = a.constrainRotation),
        (e =
          void 0 === e || !0 === e ? kb() : !1 === e ? ib : ha(e) ? jb(e) : ib))
      : (e = hb);
    this.j = new lb(g, d, e);
    void 0 !== a.resolution
      ? (c.resolution = a.resolution)
      : void 0 !== a.zoom &&
        (c.resolution = this.constrainResolution(this.a, a.zoom - this.c));
  ...
  l.Xe = function (a, c, d) {
    ...
    void 0 !== e.minResolution
      ? (h = e.minResolution)
      : void 0 !== e.maxZoom
      ? (h = this.constrainResolution(this.a, e.maxZoom - this.c, 0))
      : (h = 0);
    var k = a.ga(),
      m = this.Ma(),
      e = Math.cos(-m),
  ...
  l.rotate = function (a, c) {
    if (void 0 !== c) {
      var d,
        e = this.bb();
      void 0 !== e &&
        ((d = [e[0] - c[0], e[1] - c[1]]), Wb(d, a - this.Ma()), Rb(d, c));
      this.lb(d);
    }
    this.ee(a);
  };
  ...
  function qe(a) {
    return 0.5 > a ? oe(2 * a) : 1 - oe(2 * (a - 0.5));
  }
  function re(a) {
    var c = a.source,
  ...
  function Pe(a, c) {
    var d = c || [];
    d[0] = La((a[0] + 0.5) | 0, 0, 255);
    d[1] = La((a[1] + 0.5) | 0, 0, 255);
    d[2] = La((a[2] + 0.5) | 0, 0, 255);
    d[3] = La(a[3], 0, 1);
    return d;
  }
  function Qe(a) {
  ...
  var Ye = Ue("Opera") || Ue("OPR"),
    ...
    af =
      Ue("Gecko") &&
      !(-1 != Re.toLowerCase().indexOf("webkit") && !Ue("Edge")) &&
      !(Ue("Trident") || Ue("MSIE")) &&
      !Ue("Edge"),
  ...
  var kf = aa.document,
    lf =
      kf && Ze
        ? cf() || ("CSS1Compat" == kf.compatMode ? parseInt(df, 10) : 5)
        : void 0;
  ...
  function Hf(a) {
    var c = a.offsetWidth,
      d = a.offsetHeight,
      e = bf && !c && !d;
    return (ca(c) && !e) || !a.getBoundingClientRect
      ? new of(c, d)
      : ((a = Ff(a)), new of(a.right - a.left, a.bottom - a.top));
  }
  function If(a, c) {
  ...
  Pf.prototype.setMap = function (a) {
    ...
    this.s.length = 0;
    if ((this.a = a))
      (this.S ? this.S : a.A).appendChild(this.element),
        this.render !== ta &&
          this.s.push(C(a, "postrender", this.render, this)),
        a.render();
  };
  ...
  l.get = function (a) {
    ...
    a === this.b
      ? ((this.b = this.b.zb), (this.b.fc = null))
      : ((a.zb.fc = a.fc), (a.fc.zb = a.zb));
    a.zb = null;
    a.fc = this.a;
    this.a = this.a.zb = a;
    return a.kc;
  ...
  function Uf(a, c) {
    for (
      var d, e;
      Tf(a) &&
      !((d = a.b.kc), (e = d.ja[0].toString()), e in c && c[e].contains(d.ja));
  ...
  function gg(a, c, d, e, f, g) {
    var h = ig(a, e),
      ...
      m = a.Ia(h);
    a = Qb(a.Ya(h), a.f);
    c = (k * Math.floor((c - m[0]) / e + (f ? 0.5 : 0))) / a[0];
    d = (k * Math.floor((d - m[1]) / e + (f ? 0 : 0.5))) / a[1];
    f
  ...
  function sg(a) {
    ...
    this.D = "string" === typeof e ? vf("SPAN", {}, e) : e;
    d = vf(
      "BUTTON",
      { type: "button", title: d },
  ...
  function tg(a) {
    if ((a = a.frameState)) {
                  ...
                  a: {
                    ...
                    if (q.b) {
                      ...
                      for (K in g)
                        if (K in q.b)
                          for (
                            var J = g[K], M, z = 0, B = q.b[K].length;
                            z < B;
                            ++z
                          ) {
                            M = q.b[K][z];
                            ...
                            if (J.ua < Y.ua || J.wa > Y.wa)
                              if (
                                ze(
                                  M,
                                  new we(Qa(J.ua, Ja), Qa(J.wa, Ja), J.za, J.Ba)
                                ) ||
                                (J.wa - J.ua + 1 > Ja && ze(M, Y))
                              ) {
                                q = !0;
                                break a;
                              }
      ...
      for (var I in this.l)
        I in d
          ? (this.j[I] || (If(this.l[I], !0), (this.j[I] = !0)), delete d[I])
          : I in c
          ? (this.j[I] && (If(this.l[I], !1), delete this.j[I]), delete c[I])
          : (Af(this.l[I]), delete this.l[I], delete this.j[I]);
      for (I in d)
      ...
      for (var oa in a)
        oa in I ||
          ...
          (ba.src = oa),
          (d = a[oa]),
          "" === d ? (d = ba) : ((d = vf("A", { href: d })), d.appendChild(ba)),
  ...
  function vg(a) {
    ...
    this.f = null;
    "string" === typeof d
      ? (this.f = vf("SPAN", "ol-compass", d))
      : ((this.f = d), this.f.classList.add(this.f, "ol-compass"));
    d = vf(
      "BUTTON",
      {
        class: c + "-reset",
    ...
    Pf.call(this, { element: c, render: d, target: a.target });
      ...
      if (c) {
        ...
        void 0 !== d &&
          (0 < this.l &&
            ...
            d > Math.PI && (d -= 2 * Math.PI),
            a.Va(se({ rotation: d, duration: this.l, easing: ne }))),
          c.ee(0));
      }
    }
  };
    ...
    if ((a = a.frameState)) {
      ...
      if (a != this.A) {
        ...
        if (this.j) {
          ...
          d || 0 !== a
            ? d && 0 !== a && this.element.classList.remove("ol-hidden")
  ...
  xg.prototype.j = function (a, c) {
    ...
    if (e) {
      ...
      f &&
        (0 < this.f &&
          d.Va(te({ resolution: f, duration: this.f, easing: ne })),
        (d = e.constrainResolution(f, a)),
        e.Sb(d));
    }
  };
  function yg(a) {
    ...
    (void 0 !== a.attribution ? a.attribution : 1) &&
      c.push(new sg(a.attributionOptions));
    return c;
  }
  var zg = bf
  ...
  function Ag() {
    ...
    return !!(
      ...
      (c.mozRequestFullScreen && a.mozFullScreenEnabled) ||
      (c.msRequestFullscreen && a.msFullscreenEnabled) ||
      (c.requestFullscreen && a.fullscreenEnabled)
    );
  }
  function Bg(a) {
  ...
  function Dg(a) {
    ...
    c = vf(
      "BUTTON",
      { class: this.f + "-" + Cg(), type: "button", title: c },
      this.j
    );
  ...
  Dg.prototype.A = function () {
    var a = this.element.firstElementChild,
      c = this.a;
    Cg()
      ? ((a.className = this.f + "-true"), Bf(this.o, this.j))
      : ((a.className = this.f + "-false"), Bf(this.j, this.o));
    c && c.Rc();
  };
  ...
  l.setMap = function (a) {
    ...
    a &&
      ((a = a.a),
      this.s.push(
        C(a, "mousemove", this.Lk, this),
        C(a, "mouseout", this.Mk, this)
      ));
  };
  l.Xh = function (a) {
  ...
  function Ng(a, c) {
    var d = 0;
    a.pressure ? (d = a.pressure) : (d = c ? 0.5 : 0);
    return d;
  }
  var Og = !1;
  try {
        ...
        if (void 0 === a) {
          ...
          for (var f in e)
            f in c.style &&
              ...
              (d = aa.getComputedStyle(c).getPropertyValue(e[f])));
  ...
  function Tg(a, c) {
    ...
    if (Rg()) {
      ...
      (a.style.left = Math.round(c[12]) + "px"),
  ...
  if ("WebGLRenderingContext" in aa)
    try {
      ...
      lh &&
        ((ih = !0),
        (jh = lh.getParameter(lh.MAX_TEXTURE_SIZE)),
  ...
  function oh(a, c) {
    for (
      var d = a.g, e = c.clientX, f = c.clientY, g = 0, h = d.length, k;
      g < h && (k = d[g]);
      g++
    ) {
  ...
  l.jl = function (a) {
    if (!oh(this, a)) {
      ...
      c &&
        c.button === a.button &&
        ((c = ph(a)), rh(this.b, vh, c, a), delete this.a[(1).toString()]);
    }
  };
  l.il = function (a) {
    if (!oh(this, a)) {
  ...
  l.kl = function (a, c) {
    ...
    if (d) {
      ...
      e &&
        ...
        (e.target = f),
        c.target
          ? (xh(this.b, e, a), wh(this.b, c, a))
          : ((c.target = f), (c.relatedTarget = null), this.Oe(a, c)));
      d.out = c;
      d.Eh = c.target;
    }
  };
  ...
  l.Vo = function (a, c) {
    ...
    c.isPrimary &&
      ((this.g = void 0), (this.f = aa.setTimeout(this.Vh.bind(this), 200)));
  };
  l.Ro = function (a) {
    Eh(this, a, this.Oe);
  };
  ...
  function Jh(a) {
    ...
    gh
      ...
      : hh
      ? Kh(this, new yh(this))
      : ((a = new nh(this)), Kh(this, a), fh && Kh(this, new Ch(this, a)));
    a = this.a.length;
  ...
  function Sh(a, c) {
    ...
    a.b(d);
    0 !== a.j
      ? (aa.clearTimeout(a.j), (a.j = 0), (d = new Qh(Uh, a.f, c)), a.b(d))
      : (a.j = aa.setTimeout(
          function () {
            this.j = 0;
  ...
  function Wh(a, c) {
    c.type == Xh || c.type == Yh
      ? delete a.A[c.pointerId]
      : c.type == Zh && (a.A[c.pointerId] = !0);
  ...
  l.Ok = function (a) {
    ...
    this.g = a;
    0 === this.c.length &&
      ((this.a = new Jh(document)),
      this.c.push(
        C(this.a, $h, this.Gl, this),
        C(this.a, Xh, this.Jg, this),
        C(this.i, Yh, this.Jg, this)
      ));
  };
  l.Gl = function (a) {
  ...
  l.setMap = function (a) {
    ...
    a &&
      ...
      (this.o = C(this, "change", a.render, a)),
      this.u());
  };
  l.Cc = function (a) {
    this.set("source", a);
  ...
  function ui(a, c, d) {
    return [
      c * (Math.round(a[0] / c) + (d[0] % 2) / 2),
      c * (Math.round(a[1] / c) + (d[1] % 2) / 2),
    ];
  }
        ...
        for (D = v.za; D <= v.Ba; ++D)
          h - z <= k
            ? ((t = c.Lb(z, A, D, e, f)),
              0 == t.V() &&
                ((q[t.ja.toString()] = !0),
                t.gb() in a.g || a.f([t, p, hg(d, t.ja), w])),
              void 0 !== m && m.call(n, t))
            : c.Rf(z, A, D, f);
  }
  function wi(a) {
  ...
  zi.prototype.U = function () {
    ...
    if (!this.s && null !== this.j) {
      ...
      for (
        var c = a.getImageData(0, 0, this.a.width, this.a.height),
          d = c.data,
          e = this.j[0] / 255,
          f = this.j[1] / 255,
          g = this.j[2] / 255,
  ...
  zi.prototype.load = function () {
    if (0 == this.f) {
      this.f = 1;
      this.i = [
        xb(this.a, "error", this.A, this),
        xb(this.a, "load", this.U, this),
      ];
      try {
        this.a.src = this.l;
      } catch (a) {
  ...
  l.sf = function (a, c, d, e, f, g) {
    ...
    for (q = p.length - 1; 0 <= q; --q) {
      ...
      if (
        hi(t, n) &&
        f.call(g, r) &&
        ((t = Ei(this, r)), r.ea() && (k = t.ib(r.ea().N ? m : a, c, h, e)), k)
      )
        return k;
    }
  };
  ...
  function Ii(a, c) {
    for (
      var d = a.b, e = a.a, f = d.length, g = d[c], h = e[c], k = c;
      c < f >> 1;
  ...
  function Qi(a, c, d, e, f) {
    if (void 0 !== d) {
      ...
      void 0 !== g &&
        ...
        f &&
        0 < f &&
        (a.Va(se({ rotation: g, duration: f, easing: ne })),
  ...
  function Si(a, c, d, e, f) {
    if (d) {
      ...
      void 0 !== g &&
        ...
        f &&
        0 < f &&
        (a.Va(te({ resolution: g, duration: f, easing: ne })),
        e && a.Va(re({ source: h, duration: f, easing: ne })));
      if (e) {
        var k;
        a = c.bb();
  ...
  function dj(a) {
    ...
    if (d === Zh || d === ai || d === Xh)
      (d = a.b),
        a.type == Xh
          ? delete this.xa[d.pointerId]
          : a.type == Zh
          ? (this.xa[d.pointerId] = d)
          : d.pointerId in this.xa && (this.xa[d.pointerId] = d),
        (this.o = ob(this.xa));
    this.N &&
      (a.type == ai ? this.He(a) : a.type == Xh && (this.N = this.Je(a)));
    a.type == Zh
      ? ((this.N = a = this.Uc(a)), (c = this.Dc(a)))
      : a.type == $h && this.Ie(a);
    return !c;
  }
  ...
  function ij(a) {
    ...
    if (0 === this.o.length) {
      ...
      d &&
        ...
        a.Va(this.l),
        (g = a.Ga(g)),
        (d = a.Oa([g[0] - d * Math.cos(f), g[1] - d * Math.sin(f)])),
        (d = c.Md(d)),
        c.lb(d));
      le(c, -1);
      a.render();
  ...
  function gj(a) {
    if (0 < this.o.length && this.B(a)) {
      ...
      this.l &&
        $a(c.D, this.l) &&
        (d.lb(a.frameState.viewState.center), (this.l = null));
  ...
  function kj(a) {
    return bj(a) && Wi(a) && this.c(a)
      ? ((a = a.map), le(a.aa(), 1), a.render(), (this.a = void 0), !0)
      : !1;
  }
  jj.prototype.Dc = Uc;
  function nj(a) {
  ...
  function uj(a) {
    if (!bj(a)) return !0;
    this.a.setMap(null);
    this.B(a, this.c, a.pixel) &&
      (this.s(a), this.b(new qj("boxend", a.coordinate, a)));
    return !1;
  }
  function sj(a) {
  ...
  function yj(a) {
    ...
    if ("keydown" == a.type) {
      ...
      if (this.c(a) && (40 == d || 37 == d || 39 == d || 38 == d)) {
        ...
        f = this.o;
        if ((g = c.bb()))
          f && 0 < f && e.Va(re({ source: g, duration: f, easing: pe })),
  ...
  function Cj(a) {
    ...
    if ("wheel" == a.type || "mousewheel" == a.type) {
      ...
      "wheel" == a.type
        ? ((e = d.deltaY),
          Yg && d.deltaMode === aa.WheelEvent.DOM_DELTA_PIXEL && (e /= ah),
          d.deltaMode === aa.WheelEvent.DOM_DELTA_LINE && (e *= 40))
        : "mousewheel" == a.type && ((e = -d.wheelDeltaY), Zg && (e /= 3));
      this.c += e;
  ...
  function Dj(a) {
    ...
    this.a = !1;
    this.s = 0;
    this.H = void 0 !== a.threshold ? a.threshold : 0.3;
  ...
  function Fj(a) {
    ...
    void 0 !== this.l &&
      ((c = d - this.l),
      (this.s += c),
      !this.a && Math.abs(this.s) > this.H && (this.a = !0));
    this.l = d;
    a = a.map;
  ...
  function Lj(a) {
    ...
    (void 0 !== a.pinchZoom ? a.pinchZoom : 1) &&
      c.push(new Hj({ duration: a.zoomDuration }));
    if (void 0 !== a.keyboard ? a.keyboard : 1)
      c.push(new xj()),
        c.push(new zj({ delta: a.zoomDelta, duration: a.zoomDuration }));
    (void 0 !== a.mouseWheelZoom ? a.mouseWheelZoom : 1) &&
      c.push(new Bj({ duration: a.zoomDuration }));
    (void 0 !== a.shiftDragZoom ? a.shiftDragZoom : 1) &&
      c.push(new wj({ duration: a.zoomDuration }));
    return c;
  }
  function Mj(a) {
    var c = a || {};
  ...
  l.Hk = function () {
    ...
    for (d = a.length; c < d; c++)
      (e = a[c]),
        (this.a[x(e).toString()] = [
          C(e, "propertychange", this.Wd, this),
          C(e, "change", this.Wd, this),
        ]);
    this.u();
  };
  l.Gk = function (a) {
    ...
    var c = x(a).toString();
    this.a[c] = [
      C(a, "propertychange", this.Wd, this),
      C(a, "change", this.Wd, this),
    ];
    this.u();
  };
  l.Ik = function (a) {
  ...
  l.bf = function (a) {
    ...
    for (e = c.length; d < e; d++)
      (f = c[d]),
        ...
        void 0 !== a.extent &&
          (f.extent = void 0 !== f.extent ? Pc(f.extent, a.extent) : a.extent);
    return c;
  };
  l.df = function () {
    return "ready";
  ...
  function kd(a, c, d) {
    ...
    for (var f = 0; f < e; f += d)
      (c[f] = (6378137 * Math.PI * a[f]) / 180),
        (c[f + 1] =
          6378137 * Math.log(Math.tan((Math.PI * (a[f + 1] + 90)) / 360)));
    return c;
  }
  function ld(a, c, d) {
    var e = a.length;
    ...
    void 0 === c && (2 < d ? (c = a.slice()) : (c = Array(e)));
    for (var f = 0; f < e; f += d)
      (c[f] = (180 * a[f]) / (6378137 * Math.PI)),
        (c[f + 1] =
          (360 * Math.atan(Math.exp(a[f + 1] / 6378137))) / Math.PI - 90);
    return c;
  }
  ...
  var Tj = [-180, -90, 180, 90],
    ...
    md = [
      new Sj("CRS:84"),
      new Sj("EPSG:4326", "neu"),
      new Sj("urn:ogc:def:crs:EPSG::4326", "neu"),
      new Sj("urn:ogc:def:crs:EPSG:6.6:4326", "neu"),
      new Sj("urn:ogc:def:crs:OGC:1.3:CRS84"),
      new Sj("urn:ogc:def:crs:OGC:2:84"),
      new Sj("http://www.opengis.net/gml/srs/epsg.xml#4326", "neu"),
      new Sj("urn:x-ogc:def:crs:EPSG:4326", "neu"),
    ];
  function Vj() {
    bd(jd);
    bd(md);
  ...
  function dk(a) {
    void 0 === a.a &&
      (a.a =
        a.b instanceof CanvasPattern || a.b instanceof CanvasGradient
          ? x(a.b).toString()
          : "f" + (a.b ? Oe(a.b) : "-"));
    return a.a;
  }
  ...
  function gk(a, c, d) {
    ...
    a.b[1] =
      (a.b[1] + (f + (((h << 21) & 4294967295) | (h >>> 11)))) & 4294967295;
  ...
  function kk(a) {
    ...
    if (void 0 === c)
      (this.b = document.createElement("CANVAS")),
        ...
        this.f
          ? (this.i = this.b)
          : ((c = this.i = document.createElement("CANVAS")),
            (c.height = f.size),
            (c.width = f.size),
            (c = c.getContext("2d")),
            this.zh(f, c, 0, 0));
      ...
      var g = this.a ? jk(this.a) : "-",
        k = this.f ? dk(this.f) : "-";
      (this.c && g == this.c[1] && k == this.c[2] && this.g == this.c[3]) ||
        (this.c = [
          "c" + g + k + (void 0 !== this.g ? this.g.toString() : "-"),
          g,
          k,
          this.g,
        ]);
  ...
  l.Ah = function (a, c, d, e) {
    ...
    this.a &&
      ...
      (c.lineWidth = a.yd),
      a.lineDash && c.setLineDash(a.lineDash),
      c.stroke());
    c.closePath();
  };
  ...
  function pk() {
    if (!ok) {
      ...
      ok = [
        new lk({
          image: new kk({ fill: a, stroke: c, radius: 5 }),
          fill: a,
          stroke: c,
        }),
      ];
  ...
  function qk() {
    var a = {},
      c = [255, 255, 255, 1],
      d = [0, 153, 255, 1];
    a.Polygon = [new lk({ fill: new ck({ color: [255, 255, 255, 0.5] }) })];
    a.MultiPolygon = a.Polygon;
    a.LineString = [
      new lk({ stroke: new ik({ color: c, width: 5 }) }),
      new lk({ stroke: new ik({ color: d, width: 3 }) }),
    ];
    ...
    a.Point = [
      new lk({
        image: new kk({
          radius: 6,
          fill: new ck({ color: d }),
          stroke: new ik({ color: c, width: 1.5 }),
        }),
        zIndex: Infinity,
      }),
    ];
  ...
  function vk(a, c) {
    ...
    e
      ...
      : ((d.fillStyle = c.fillStyle), (a.Y = { fillStyle: c.fillStyle }));
  }
  function wk(a, c) {
    var d = a.f,
      e = a.xa;
  ...
  l.Tb = function (a) {
    if (a) {
      var c = a.b;
      c
        ? ((c = c.b), (this.o = { fillStyle: Qe(c ? c : Yj) }))
        : (this.o = null);
      var d = a.j;
      if (d) {
        var c = d.b,
  ...
  function Jk(a, c, d, e, f, g) {
    ...
    for (q = d + f; q < e; q += f)
      (n[0] = c[q]),
        ...
        (t = xc(k, n)),
        t !== r
          ? (p && ((a.coordinates[h++] = m[0]), (a.coordinates[h++] = m[1])),
            (a.coordinates[h++] = n[0]),
            (a.coordinates[h++] = n[1]),
            (p = !1))
          : 1 === t
          ? ((a.coordinates[h++] = n[0]), (a.coordinates[h++] = n[1]), (p = !1))
          : (p = !0),
        (m[0] = n[0]),
        (m[1] = n[1]),
        (r = t);
  ...
  function Lk(a, c, d, e, f, g, h, k, m) {
    ...
    li(e, a.xa)
      ? (n = a.Y)
      : ((n = wd(a.coordinates, 0, a.coordinates.length, 2, e, a.Y)),
        gc(a.xa, e));
    e = !pb(g);
    var p = 0,
      q = h.length,
      ...
      switch (B[0]) {
        ...
        case 5:
          ...
          for (K = B[9]; r < t; r += 2) {
            ...
            oa = ba.length;
            1 < oa
              ? ((Ta = Math.round(1.5 * c.measureText("M").width)),
                (Y -= ((oa - 1) / 2) * Ta))
              : (Ta = 0);
            for (Aa = 0; Aa < oa; Aa++)
              (Ka = ba[Aa]),
          ...
          break;
        case 6:
          if (void 0 !== k && ((r = B[1]), (r = k(r)))) return r;
          ++p;
          break;
        case 7:
          c.fill();
  ...
  l.Ye = function () {
    this.f ||
      ((this.f = rc(this.T)),
      0 < this.c && qc(this.f, (this.resolution * (this.c + 1)) / 2, this.f));
    return this.f;
  };
  function Rk(a) {
    var c = a.g,
    ...
    (c.bd == d &&
      ...
      c.$c == h &&
      c.ad == k) ||
      (c.gf != a.coordinates.length &&
        (a.a.push([12]), (c.gf = a.coordinates.length)),
      a.a.push([10, d, h, e, g, k, f], [1]),
      (c.bd = d),
      (c.Xc = e),
      (c.Yc = f),
      (c.Zc = g),
  ...
  l.Qb = function (a, c) {
    ...
    c
      ? ((e = c.b),
        (d.strokeStyle = Oe(e ? e : ak)),
        (e = c.f),
        (d.lineCap = void 0 !== e ? e : "round"),
        (e = c.g),
        (d.lineDash = e ? e.slice() : Zj),
        (e = c.c),
        ...
        d.lineWidth > this.c && ((this.c = d.lineWidth), (this.f = null)))
  ...
  function Wk(a, c, d, e, f) {
    if ("" !== a.o && a.j && (a.g || a.i)) {
      ...
      a.i &&
        ...
        (h &&
          h.lineCap == g.lineCap &&
          h.lineDash == g.lineDash &&
          h.lineJoin == g.lineJoin &&
          h.lineWidth == g.lineWidth &&
          h.miterLimit == g.miterLimit &&
      ...
      (h &&
        ...
        h.textAlign == g.textAlign &&
        h.textBaseline == g.textBaseline) ||
        ((k = [11, g.font, g.textAlign, g.textBaseline]),
        a.a.push(k),
        a.b.push(k),
        h
          ? ((h.font = g.font),
  ...
  Vk.prototype.Tb = function (a) {
    if (a) {
      ...
      c
        ? ((c = c.b),
          (c = Qe(c ? c : Yj)),
          this.g ? (this.g.fillStyle = c) : (this.g = { fillStyle: c }))
        : (this.g = null);
      var d = a.j;
      if (d) {
        var c = d.b,
      ...
      k = void 0 !== k ? k : "middle";
      this.j
        ? ((m = this.j), (m.font = a), (m.textAlign = g), (m.textBaseline = k))
        : (this.j = { font: a, textAlign: g, textBaseline: k });
      this.o = void 0 !== d ? d : "";
      this.l = void 0 !== c ? c : 0;
      this.s = void 0 !== e ? e : 0;
      this.A = void 0 !== f ? f : 0;
  ...
  Xk.prototype.f = function (a, c, d, e, f) {
    var g = this.o;
    ki(g, 0.5, 0.5, 1 / c, -1 / c, -d, -a[0], -a[1]);
    var h = this.j;
    h.clearRect(0, 0, 1, 1);
    var k;
  ...
  function Zk(a, c, d, e, f, g, h) {
    ...
    for (n = k.length; m < n; ++m)
      for (q = a.g[k[m].toString()], p = Hk.length - 1; 0 <= p; --p)
        if (
          ((r = q[Hk[p]]),
          void 0 !== r && (r = Lk(r, c, 1, d, e, f, r.b, g, h)))
        )
          return r;
  }
  ...
  l.G = function () {
    this.a ||
      (this.a =
        "Point" === this.g ? zc(this.b) : Ac(this.b, 0, this.b.length, 2));
    return this.a;
  };
  l.Mb = function () {
    return this.b;
      ...
      h &&
        ...
        gl
          ? ((m = (a + v + ba) / 3),
            ...
            q.lineTo(v[0], v[1]),
            q.lineTo(ba[0], ba[1]))
          : (q.moveTo(a, p), q.lineTo(v, I), q.lineTo(ba, oa)),
        q.closePath(),
        q.clip(),
        q.transform(h[0], h[2], h[1], h[3], a, p),
        q.translate(r[0] - f, r[3] - c),
        q.scale(e / d, -e / d),
        q.drawImage(t.canvas, 0, 0),
        q.restore());
    });
    p &&
      (q.save(),
  ...
  function ll(a, c, d, e, f, g, h, k, m, n) {
    ...
    if (t || !a.i || Qc(p, a.i)) {
      ...
      if (
        0 < n &&
        (t ||
          ((q = a.a([(c[0] + e[0]) / 2, (c[1] + e[1]) / 2])),
          (p = r
            ? (Qa(g[0], a.b) + Qa(k[0], a.b)) / 2 - Qa(q[0], a.b)
            : (g[0] + k[0]) / 2 - q[0]),
          (q = (g[1] + k[1]) / 2 - q[1]),
          (t = p * p + q * q > a.s)),
        t)
        ...
        Math.abs(c[0] - e[0]) <= Math.abs(c[1] - e[1])
          ? ((r = [(d[0] + e[0]) / 2, (d[1] + e[1]) / 2]),
            ...
            (t = a.a(q)),
            ll(a, c, d, r, q, g, h, p, t, n - 1),
            ll(a, q, r, e, f, t, p, k, m, n - 1))
          : ((r = [(c[0] + d[0]) / 2, (c[1] + d[1]) / 2]),
            (p = a.a(r)),
            (q = [(e[0] + f[0]) / 2, (e[1] + f[1]) / 2]),
            (t = a.a(q)),
            ll(a, c, r, q, f, g, p, t, m, n - 1),
            ll(a, r, d, e, q, p, h, k, t, n - 1));
        return;
      }
      if (r) {
        if (!a.l) return;
  ...
  function nl(a, c, d, e, f, g) {
    ...
    var h = c.G(),
      k = h ? Pc(d, h) : d,
      h = hl(a, c, Nc(k), e);
    this.j = new kl(a, c, k, this.s, 0.5 * h);
    this.c = e;
    this.g = d;
    a = ml(this.j);
  ...
  nl.prototype.wd = function () {
    ...
    2 == a &&
      (this.i = jl(
        ...
        this.g,
        this.j,
        [{ extent: this.pb.G(), image: this.pb.a() }],
        0
      ));
    this.state = a;
    ji(this);
  ...
  wl.prototype.gd = function (a, c, d, e) {
    ...
    a = a.slice();
    Rc(a, this.oa);
    (e = this.Y(a, c, d, [(Lc(a) / c) * d, (Mc(a) / c) * d], e)) &&
      (f = new fl(a, c, d, this.da(), e));
    this.S = f;
    this.T = this.g;
    return f;
  };
  ...
  function Dl(a, c, d) {
    if (4 == a.nodeType || 3 == a.nodeType)
      c
        ? d.push(String(a.nodeValue).replace(/(\r\n|\r|\n)/g, ""))
        : d.push(a.nodeValue);
    ...
    for (var h = (void 0 !== f ? f : d).length, k, m, n = 0; n < h; ++n)
      (k = d[n]),
        void 0 !== k &&
          ...
          void 0 !== m && a[m.namespaceURI][m.localName].call(g, m, k, e));
  }
      ...
      k.onload = function () {
        if (200 <= k.status && 300 > k.status) {
          ...
          "json" == a || "text" == a
            ? (f = k.responseText)
            : "xml" == a
            ? (f = k.responseXML) || (f = Gl(k.responseText))
            : "arraybuffer" == a && (f = k.response);
  ...
  (function () {
    ...
    (function () {
      function c(a, d) {
        ...
        this.ag = Math.max(2, Math.ceil(0.4 * this.Ne));
        d && this.dj(d);
        this.clear();
      }
      function d(a, c) {
      ...
      c.prototype = {
          ...
          for (var f = [], g, h, k, m; c; ) {
            ...
            for (h = c.children.length; g < h; g++)
              (k = c.children[g]),
                (m = c.La ? e(k) : k.bbox),
                p(a, m) &&
                  (c.La ? d.push(k) : n(a, m) ? this.Wf(k, d) : f.push(k));
            c = f.pop();
          }
          return d;
        },
        load: function (a) {
          ...
          this.data.children.length
            ? this.data.height === a.height
              ? this.cg(this.data, a)
              : (this.data.height < a.height &&
                  ((c = this.data), (this.data = a), (a = c)),
                this.$f(a, this.data.height - a.height - 1, !0))
            : (this.data = a);
          return this;
        },
        Aa: function (a) {
        ...
        remove: function (a) {
          if (!a) return this;
          for (
            var c = this.data, d = this.jb(a), e = [], f = [], g, h, k, m;
            c || e.length;

          ) {
            c ||
              ((c = e.pop()), (h = e[e.length - 1]), (g = f.pop()), (m = !0));
        ...
        Wf: function (a, c) {
          for (var d = []; a; )
            a.La ? c.push.apply(c, a.children) : d.push.apply(d, a.children),
              (a = d.pop());
          return c;
        },
        Yf: function (a, c, e, f) {
          ...
          for (q(a, c, e, h, this.Pe); c <= e; c += h)
            for (
              n = Math.min(c + h - 1, e), q(a, c, n, g, this.Qe), m = c;
              m <= n;
              m += g
            )
              (p = Math.min(m + g - 1, n)),
          ...
          for (var f, g, h, m, n, p, q, r; ; ) {
            ...
            for (g = c.children.length; f < g; f++)
              (h = c.children[f]),
                ...
                (p = h.bbox),
                (p =
                  (Math.max(p[2], a[2]) - Math.min(p[0], a[0])) *
                    (Math.max(p[3], a[3]) - Math.min(p[1], a[1])) -
                  n),
                p < r
                  ? ((r = p), (q = n < q ? n : q), (m = h))
                  : p === r && n < q && ((q = n), (m = h));
        ...
        bj: function (a) {
          for (var c = a.length - 1, e; 0 <= c; c--)
            0 === a[c].children.length
              ? 0 < c
                ? ((e = a[c - 1].children), e.splice(e.indexOf(a[c]), 1))
                : this.clear()
              : d(a[c], this.jb);
        },
        dj: function (a) {
  ...
  function Q(a) {
    ...
    void 0 !== a.loader
      ? (this.D = a.loader)
      : void 0 !== this.S && (this.D = Ul(this.S, this.na));
  ...
  l.je = function () {
    ...
    this.c
      ? (a = this.c.a)
      : this.a && ((a = bm(this.a)), pb(this.i) || Za(a, ob(this.i)));
    return a;
  };
  l.wg = function (a) {
    var c = [];
  ...
  l.yh = function (a) {
    ...
    d
      ? ((d = d.G()),
        c in this.i
          ? (delete this.i[c], this.a && this.a.Aa(d, a))
          : this.a && am(this.a, d, a))
      : c in this.i || (this.a && this.a.remove(a), (this.i[c] = a));
    d = a.Wa();
    void 0 !== d
      ? ((d = d.toString()),
        c in this.o
          ? (delete this.o[c], (this.j[d] = a))
          : this.j[d] !== a && (lm(this, a), (this.j[d] = a)))
      : c in this.o || (lm(this, a), (this.o[c] = a));
    this.u();
  ...
  l.uj = function (a, c, d, e, f) {
    ...
    Yk(g);
    if (h) return null;
    this.j[0] != e[0] || this.j[1] != e[1]
      ? ((this.i.canvas.width = e[0]),
        (this.i.canvas.height = e[1]),
        (this.j[0] = e[0]),
        (this.j[1] = e[1]))
      : this.i.clearRect(0, 0, e[0], e[1]);
  ...
  om.prototype.zc = function (a, c, d, e) {
    if (this.f && this.f.a())
      if (this.a.ea() instanceof mm) {
        ...
        (this.i || ((this.i = cc()), jc(this.l, this.i)),
        (c = [0, 0]),
        mi(this.i, a, c),
        this.j || (this.j = Pg(1, 1)),
        ...
        0 < this.j.getImageData(0, 0, 1, 1).data[3])
      )
        return d.call(e, this.a);
  };
  om.prototype.o = function (a, c) {
    ...
    k[0] ||
      k[1] ||
      Kc(m) ||
      ((e = h.B(m, g, d, e.projection)) && pi(this, e) && (this.f = e));
    if (this.f) {
      var e = this.f,
        k = e.G(),
        m = e.$(),
  ...
  pm.prototype.c = function (a, c, d) {
    ...
    for (var Y = 0, Ja = K.length; Y < Ja; ++Y) {
      var I = K[Y],
        ...
        fc =
          Math.round(((oa[0] - Aa[0]) * q) / ba) * ba +
          n +
          Math.round((Aa[0] - g[0]) * q),
        oa =
          Math.round(((Aa[1] - oa[3]) * q) / Ka) * Ka +
          p +
          Math.round((g[1] - Aa[1]) * q);
      if (!c) {
    ...
    r &&
      ...
      Ek(this, "render", m, a, g));
    (k || r) &&
      d.drawImage(m.canvas, -Math.round(w), -Math.round(A), z / D, z / D);
    m.globalAlpha = B;
    Fk(this, d, a, f);
  };
  pm.prototype.o = function (a, c) {
    ...
    var e = a.pixelRatio,
      ...
      q = f.center;
    p == f.resolution
      ? ((q = ui(q, p, a.size)), (f = Oc(q, p, f.rotation, a.size)))
      : (f = a.extent);
  ...
  qm.prototype.c = function (a, c, d) {
    ...
    if (q && !q.Qa()) {
      var r;
      Gb(this.a, "render")
        ? ((this.s.canvas.width = d.canvas.width),
          (this.s.canvas.height = d.canvas.height),
          (r = this.s))
        : (r = d);
      var t = r.globalAlpha;
  ...
  qm.prototype.o = function (a) {
    ...
    e.N &&
      k.projection.a &&
      !wc(q, a.extent) &&
      ((a = Math.max(Lc(m) / 2, Lc(q))), (m[0] = q[0] - a), (m[2] = q[2] + a));
    if (!this.i && this.B == n && this.N == g && this.U == h && wc(this.A, m))
      return !0;
    this.j = null;
    this.i = !1;
    var r = new Xk((0.5 * n) / p, m, n, d.a);
    e.Jc(m, n, f);
    if (h) {
      var t = [];
      e.wb(
  ...
  zm.prototype.c = function (a, c, d) {
    ...
    for (J = c.length; B < J; ++B)
      if (
        ((ba = c[B]),
        (K = ba.c),
        (Ja = A.Da(ba.ja, this.U)),
        (D = ba.ja[0]),
        (Ta = Qb(A.Ya(D), this.N)),
        (I = "tile-pixels" == ba.g.g),
        (M = A.$(D)),
        (oa = M / t),
        (z = M / m),
        (M = Math.round((e * n[0]) / 2)),
        (Y = Math.round((e * n[1]) / 2)),
        (Aa = Ta[0] * e * z),
        (z *= Ta[1] * e),
        (Ta = Ta[0] * e),
        Aa < Ta / 4 || Aa > 4 * Ta)
        ...
        D = pg(r, D, e, k);
        I
          ? (oa = ki(this.j, 0, 0, p * oa, p * oa, g, -D[0] / 2, -D[1] / 2))
          : ((oa = Nc(Ja)), (oa = ki(this.j, 0, 0, p, -p, -g, -oa[0], -oa[1])));
        ba = ba.l;
        if (K.resolution !== m || K.rotation !== g)
          (K.resolution = m),
            (K.rotation = g),
            (ba.canvas.width = Aa + 0.5),
            (ba.canvas.height = z + 0.5),
  ...
  function Am(a, c, d, e, f) {
    ...
    if (m.cd || m.Uh != h || m.Nf != k) {
      ...
      var n = d.ea(),
        ...
        w;
      t
        ? ((v = pg(n, q[0], e, c.g)), (v = [0, 0, v[0], v[1]]))
        : ((v = p.Da(q)), qd(f, r) || ((w = !0), c.pf(f)));
      var A = p.$(q[0]),
        n = t ? n.Yb(e) : A;
      m.cd = !1;
        ...
        tc(w, a) &&
          ("tile-pixels" === A.g.g
            ? ((w = Ic(w)),
              (g = n.Yb(f)),
              (r = p.$(r[0]) / g),
              (r = [(a[0] - w[0]) / r, (w[1] - a[1]) / r]))
            : (r = a),
          (A = A.c.vd),
          (q =
            q ||
            A.f(r, g, c, {}, function (a) {
              var c = x(a).toString();
  ...
  Bm.prototype.xe = function (a) {
    if (a) {
      ...
      this.b.width != e || this.b.height != d
        ? ((this.b.width = e), (this.b.height = d))
        : c.clearRect(0, 0, e, d);
  ...
  Em.prototype.tf = function (a, c) {
    ...
    m[0] ||
      m[1] ||
      Kc(n) ||
      ((d = k.B(n, f, a.pixelRatio, d.projection)) && pi(this, d) && (h = d));
    h &&
      ((m = h.G()),
      (n = h.$()),
      (d = cc()),
      ...
      h != this.f &&
        ...
        (this.f = h)),
      li(d, this.c) || (Tg(this.target, d), gc(this.c, d)),
      ri(a.attributions, h.da()),
      si(a, k));
    return !0;
  };
  function Fm(a) {
  ...
  Fm.prototype.tf = function (a, c) {
    ...
    var d = a.pixelRatio,
      ...
      r;
    p == e.resolution
      ? ((q = ui(q, p, a.size)), (r = Oc(q, p, e.rotation, a.size)))
      : (r = a.extent);
    ...
    for (K = A.length; J < K; ++J) {
      ...
      M in this.f
        ? (w = this.f[M])
        : ((w = k.md(q, M)), (w = new Gm(k, w)), (v[M] = !0), (this.f[M] = w));
      M = t[M];
      for (Y in M) {
        z = w;
        B = M[Y];
        ...
        if (!(I in z.a)) {
          ...
          0 < Ja
            ? ((fc = document.createElement("DIV")),
              ...
              (Ka.left = -Ja + "px"),
              (Ka.top = -Ja + "px"),
              (Ka.width = ba[0] + 2 * Ja + "px"),
              (Ka.height = ba[1] + 2 * Ja + "px"),
              fc.appendChild(Aa))
            : ((Ka.width = ba[0] + "px"),
              (Ka.height = ba[1] + "px"),
              (fc = Aa),
        ...
        if (
          ...
          for (--M; 0 <= M; --M)
            if (M in this.f) {
              K = this.f[M].target;
              K.parentNode &&
                K.parentNode.insertBefore(w.target, K.nextSibling);
              break;
            }
  ...
  l.mh = function (a, c) {
    ...
    (h = this.c) &&
      ...
      h.a(g, d, e, f, c.Kc ? a.skippedFeatureUids : {}),
      Im(this, "render", a, e));
  ...
  function Im(a, c, d, e) {
    ...
    a = a.a;
    Gb(a, c) &&
      ((e = new sk(f, d.pixelRatio, d.extent, e, d.viewState.rotation)),
      a.b(new fi(c, a, e, d, f, null)));
  }
  ...
  function Sm(a, c) {
    ...
    (this.g = Wa(sa, "OES_element_index_uint")) &&
  ...
  function Tm(a, c, d) {
    ...
    if (g in a.a) e.bindBuffer(c, a.a[g].buffer);
      ...
      34962 == c
        ...
        : 34963 == c && (k = a.g ? new Uint32Array(f) : new Uint16Array(f));
    ...
    if (pb(e)) {
      ...
      for (n = f.length; m < n; ++m) {
        ...
        for (
          ...
          k < a.g.length && a.g[k] <= q;

        ) {
          var t = x(a.s[k]).toString();
          void 0 !== e[t]
            ? (r !== p && c.drawElements(4, p - r, h, r * d),
              (p = r = k === a.g.length - 1 ? q : a.g[k + 1]))
            : (p = k === a.g.length - 1 ? q : a.g[k + 1]);
          k++;
        }
        r !== p && c.drawElements(4, p - r, h, r * d);
      }
  ...
  an.prototype.Rb = function (a) {
    ...
    0 === this.c.length
      ...
      : ((p = this.c[this.c.length - 1]),
        x(p) != x(d) && (this.U.push(this.a.length), this.c.push(d)));
    0 === this.f.length
      ? this.f.push(f)
      : ((p = this.f[this.f.length - 1]),
        x(p) != x(f) && (this.i.push(this.a.length), this.f.push(f)));
    this.B = c[0];
    this.N = c[1];
    this.D = n[1];
    this.va = e[1];
  ...
  function mn(a, c, d, e, f, g, h, k, m, n) {
    ...
    for (q = Hk.length - 1; 0 <= q; --q)
      if (
        ((r = a.g[Hk[q]]),
        void 0 !== r && (r = fn(r, c, d, e, f, p, g, h, k, m, n)))
      )
        return r;
  }
  ...
  tn.prototype.oh = function (a, c, d) {
    ...
    d.re(f) &&
      (e.enableVertexAttribArray(g.b),
      e.vertexAttribPointer(g.b, 2, 5126, !1, 16, 0),
    ...
    if (Gb(a, c)) {
      ...
      a.b(
        new fi(
          c,
          a,
          new pn(d, f.center, f.resolution, f.rotation, e.size, e.extent),
          e,
          null,
          d
        )
  ...
  wn.prototype.vf = function (a, c) {
    ...
    m &&
      ((d = this.f.c.j),
      yn(this, d.width, d.height, e, g, h, k, m.G()),
      (this.l = null),
      (e = this.s),
      hc(e),
      lc(e, 1, -1),
    ...
    if (this.c && this.c.a())
      if (this.a.ea() instanceof mm) {
        ...
        if (
          ...
          (this.o || (this.o = Pg(1, 1)),
          this.o.clearRect(0, 0, 1, 1),
          this.o.drawImage(this.c.a(), c[0], c[1], 1, 1, 0, 0, 1, 1),
  ...
  l.vf = function (a, c, d) {
    var e = this.f,
      ...
      D;
    q == g.resolution
      ? ((A = ui(A, q, a.size)), (D = Oc(A, q, g.rotation, a.size)))
      : (D = a.extent);
    q = fg(n, D, q);
    if (this.o && ye(this.o, q) && this.l == m.g) v = this.B;
      ...
      var z = [q.wa - q.ua + 1, q.Ba - q.za + 1],
        B = Math.pow(
          2,
          Math.ceil(Math.log(Math.max(z[0] * r[0], z[1] * r[1])) / Math.LN2)
        ),
        z = v * B,
        J = n.Ia(p),
        K = J[0] + q.ua * r[0] * v,
      ...
      c.sort(Va);
      for (
        var M = new Float32Array(4), Ta, Aa, Ka, Y = 0, Ja = c.length;
        Y < Ja;
        ++Y
      )
        for (Ta in ((Aa = d[c[Y]]), Aa))
          (J = Aa[Ta]),
            ...
            f.drawArrays(5, 0, 4);
      B
        ? ((this.o = q), (this.B = v), (this.l = m.g))
        : ((this.B = this.o = null), (this.l = -1), (a.animate = !0));
    }
    ...
    if (Rf(a.a, g))
      ...
      if (0 < e) {
        var k = a.N.canvas,
          m = a.N;
        a.B !== d[0] || a.U !== d[1]
          ? ((k.width = d[0]), (k.height = d[1]), (a.B = d[0]), (a.U = d[1]))
    ...
    if (Gb(e, c)) {
      ...
      e.b(
        new fi(
          c,
          e,
          new pn(a, f.center, f.resolution, f.rotation, d.size, d.extent),
          d,
          null,
          a
        )
  ...
  l.xe = function (a) {
    ...
    for (k = f.length; h < k; ++h)
      (n = f[h]),
        hi(n, g) &&
          "ready" == n.D &&
          ((m = Ei(this, n.layer)), m.vf(a, n, c) && e.push(n));
    ...
    Ci(a);
    1024 < this.a.tc() - this.j &&
      a.postRenderFunctions.push(this.wj.bind(this));
  ...
  l.fa = function () {
    ...
    void 0 !== this.c &&
      (aa.removeEventListener("resize", this.c, !1), (this.c = void 0));
  ...
  l.Ga = function (a) {
    var c = this.f;
    return c
      ? ((a = a.slice(0, 2)), mi(c.coordinateToPixelMatrix, a, a))
      : null;
  };
  l.ab = function () {
  ...
  l.Vk = function () {
    ...
    a
      ? (a.appendChild(this.a),
        (a = this.ya ? this.ya : a),
        (this.s = [
          C(a, "keydown", this.Ic, this),
          C(a, "keypress", this.Ic, this),
        ]),
        this.c ||
          ((this.c = this.Rc.bind(this)),
          aa.addEventListener("resize", this.c, !1)))
      : (Af(this.a),
        void 0 !== this.c &&
          (aa.removeEventListener("resize", this.c, !1), (this.c = void 0)));
    this.Rc();
  ...
  l.Ck = function () {
    ...
    a &&
      (this.H = [
        C(a, "propertychange", this.Ek, this),
        C(a, "change", this.Dk, this),
      ]);
    this.render();
  };
  l.yo = function () {
  ...
  l.xo = function (a) {
    ...
    h &&
      ...
      0 !== this.D.length ||
        ...
        h.viewHints[1] ||
        Cc(h.extent, this.Ua) ||
        (this.b(new Of("moveend", this, h)), rc(h.extent, this.Ua)));
  ...
  l.Rc = function () {
    ...
    if (a) {
      ...
      if (e && "auto" != d.width && "auto" != d.height && !d.boxSizing)
        (c = Jf(a, d.width, "width", "pixelWidth")),
        ...
        a = new of(
          d.width - a.left - c.left - c.right - a.right,
          d.height - a.top - c.top - c.bottom - a.bottom
        );
      }
  ...
  function Jn(a) {
    ...
    void 0 !== a.renderer
      ? Array.isArray(a.renderer)
        ? (g = a.renderer)
        : "string" === typeof a.renderer && (g = [a.renderer])
      : (g = In);
    var h, k;
    h = 0;
    ...
    var n;
    void 0 !== a.controls
      ? (n = Array.isArray(a.controls)
          ? new De(a.controls.slice())
          : a.controls)
      : (n = yg());
    var p;
    void 0 !== a.interactions
      ? (p = Array.isArray(a.interactions)
          ? new De(a.interactions.slice())
          : a.interactions)
      : (p = Lj());
    a =
      void 0 !== a.overlays
        ? Array.isArray(a.overlays)
          ? new De(a.overlays.slice())
          : a.overlays
        : new De();
    return {
      controls: n,
  ...
  l.Jk = function () {
    ...
    var a = this.de();
    a &&
      ((this.c = C(a, "postrender", this.render, this)),
      Ln(this),
      (a = this.s ? a.A : a.B),
      this.o ? zf(a, this.f, 0) : a.appendChild(this.f));
  };
  l.render = function () {
    Ln(this);
  };
    ...
    if (void 0 !== this.get("position") && this.autoPan) {
      ...
      if (void 0 !== a && a.vc()) {
        ...
        wc(c, h) ||
          ...
          (e = a.Ga(d)),
          (c = [e[0] + c[0], e[1] + c[1]]),
          this.i && ((this.i.source = d), a.Va(re(this.i))),
          a.aa().lb(a.Oa(c)));
      }
    }
  };
  ...
  function Mn(a, c) {
    ...
    a != (g ? f.documentElement : f.body) &&
      ...
      (d =
        Ze && jf("10") && g.pageYOffset != d.scrollTop
  ...
  l.setMap = function (a) {
    var c = this.a;
    a !== c &&
      (c && (c = c.aa()) && yb(c, Mb("rotation"), this.Xd, this),
      On.ia.setMap.call(this, a),
      a &&
        (this.s.push(C(a, "propertychange", this.Kk, this)),
        0 === this.f.Xg().Zb() && this.f.bi(a.uc()),
        (a = a.aa()))) &&
      (C(a, Mb("rotation"), this.Xd, this), ke(a) && (this.f.Rc(), Qn(this)));
  };
  l.Kk = function (a) {
    "view" === a.key &&
      ((a = a.oldValue) && yb(a, Mb("rotation"), this.Xd, this),
      (a = this.a.aa()),
      C(a, Mb("rotation"), this.Xd, this));
  };
  l.Xd = function () {
  ...
  function Pn() {
    ...
    if (a.f && c.f) {
      var d = a.ab(),
        ...
        g = e[0],
        e = e[1];
      c < 0.1 * g || f < 0.1 * e || c > 0.75 * g || f > 0.75 * e
        ? Qn(this)
        : wc(d, a) || ((a = this.f), (d = this.a.aa()), a.aa().lb(d.bb()));
    }
    Rn(this);
  }
  function Qn(a) {
    ...
    var d = c.ab(),
      ...
      d = a.ab();
    a = a.aa();
    Rc(c, 1 / (0.1 * Math.pow(2, Math.log(7.5) / Math.LN2 / 2)));
    a.Xe(c, d);
  }
  function Rn(a) {
    var c = a.a,
    ...
    if (c.f && d.f) {
      ...
      c.nf(k);
      h &&
        ((h.style.width = Math.abs((g[0] - f[0]) / e) + "px"),
        (h.style.height = Math.abs((f[1] - g[1]) / e) + "px"));
    }
  }
  l.Sl = function (a) {
    a.preventDefault();
  ...
  function Zn(a) {
    if (a.frameState) {
      if (!this.xa) {
        ...
        this.T = [e, c];
        d.width > d.height
          ? ((this.j = 1), (this.N = d.width - e))
          : ((this.j = Yn), (this.l = d.height - c));
        this.xa = !0;
      }
  ...
  l.wk = function (a) {
    ...
    a = ao(
      ...
      La(
        1 === this.j
          ? (a.offsetX - this.T[0] / 2) / this.N
          : (a.offsetY - this.T[1] / 2) / this.l,
        0,
        1
      )
    );
  ...
  l.xk = function (a) {
    if (
      ...
      var c = this.Hg;
      this.A.push(
        C(document, "mousemove", a, this),
        C(document, "touchmove", a, this),
        C(document, uh, a, this),
        C(document, "mouseup", c, this),
        C(document, "touchend", c, this),
        C(document, vh, c, this)
      );
    }
  };
  l.Gg = function (a) {
    if (this.B) {
      ...
      this.f = ao(
        ...
        La(
          1 === this.j
            ? (a.clientX - this.H + parseInt(c.style.left, 10)) / this.N
            : (a.clientY - this.D + parseInt(c.style.top, 10)) / this.l,
          0,
          1
        )
      );
  ...
  l.Gn = function (a) {
    if (null !== a.alpha) {
      ...
      "boolean" === typeof a.absolute && a.absolute
        ? this.set("heading", c)
        : ha(a.webkitCompassHeading) &&
          -1 != a.webkitCompassAccuracy &&
          this.set("heading", Pa(a.webkitCompassHeading));
    }
  ...
  l.wl = function () {
    if (dh) {
      var a = this.Tg();
      a && !this.a
        ? (this.a = C(aa, "deviceorientation", this.Gn, this))
        : a || null === this.a || (sb(this.a), (this.a = null));
    }
  };
  l.kf = function (a) {
    this.set("tracking", a);
  ...
  function ho(a, c, d) {
    ...
    e && f && !qd(e, f)
      ? a instanceof vd
        ? (g = (c ? a.clone() : a).hb(c ? e : f, c ? f : e))
        : (g = ud(c ? a.slice() : a, c ? e : f, c ? f : e))
      : (g = a);
    if (c && d && d.decimals) {
  ...
  function ko(a, c, d, e, f, g) {
    ...
    if (0 !== m)
      if (1 == m) (h = a[c]), (k = a[c + 1]);
        ...
        f = p ? m : ~m;
        0 > f
          ? ((d = (d - h[-f - 2]) / (h[-f - 1] - h[-f - 2])),
            (c += (-f - 2) * e),
            (h = Ra(a[c], a[c + e], d)),
            (k = Ra(a[c + 1], a[c + e + 1], d)))
          : ((h = a[c + f * e]), (k = a[c + f * e + 1]));
      }
  ...
  l.ub = function (a, c, d, e) {
    if (e < sc(this.G(), a, c)) return e;
    this.N != this.g &&
      ((this.H = Math.sqrt(Ed(this.v, 0, this.v.length, this.a, 0))),
      (this.N = this.g));
  ...
  l.Xl = function (a, c) {
    return "XYM" != this.f && "XYZM" != this.f
      ? null
      : lo(this.v, 0, this.v.length, this.a, a, void 0 !== c ? c : !1);
  };
  l.Z = function () {
    return Ld(this.v, 0, this.v.length, this.a);
  };
  ...
  function zk(a) {
    a.l != a.g && ((a.i = a.tg(0.5, a.i)), (a.l = a.g));
    return a.i;
  }
  l.Hc = function (a) {
    var c = [];
  ...
  l.ub = function (a, c, d, e) {
    if (e < sc(this.G(), a, c)) return e;
    this.l != this.g &&
      ((this.N = Math.sqrt(Fd(this.v, 0, this.i, this.a, 0))),
      (this.l = this.g));
    return Hd(this.v, 0, this.i, this.a, this.N, !1, a, c, d, e);
  };
  l.$l = function (a, c, d) {
    return ("XYM" != this.f && "XYZM" != this.f) || 0 === this.v.length
      ? null
      : mo(
          this.v,
          this.i,
  ...
  l.clone = function () {
    for (
      var a = new po(null), c = this.i.length, d = Array(c), e = 0;
      e < c;
      ++e
    )
      d[e] = this.i[e].slice();
  ...
  l.Z = function (a) {
    var c;
    void 0 !== a
      ? ((c = Bk(this).slice()), ae(c, this.i, this.a, a))
      : (c = this.v);
    a = c;
    c = this.i;
    var d = this.a,
  ...
  function to(a, c) {
    ...
    if (ha(a.x) && ha(a.y)) d = "Point";
      ...
      a = mb({}, a);
      1 === g.length
        ? ((d = "Polygon"), (a.rings = g[0]))
        : ((d = "MultiPolygon"), (a.rings = g));
    }
  ...
  l.Rh = function (a) {
    return a.spatialReference && a.spatialReference.wkid
      ? ad("EPSG:" + a.spatialReference.wkid)
      : null;
  };
  function yo(a, c) {
  ...
  l.kd = function (a) {
    ...
    if (f)
      return (
        (a = new zo(null)), Co(a), (a.c = d), Ao(a), a.u(), (this.j[c] = a)
      );
    this.o = a;
    return this;
  };
  ...
  var Fo = {
    ...
    Ho = {
      ...
      LineString: function (a) {
        return { type: "LineString", coordinates: a.Z() };
      },
  ...
  l.Rh = function (a) {
    return (a = a.crs)
      ? "name" == a.type
        ? ad(a.properties.name)
        : "EPSG" == a.type
        ? ad("EPSG:" + a.properties.code)
        : null
  ...
  l.sd = function (a, c) {
    ...
    if ("FeatureCollection" == d)
      ...
      for (t in e) {
        ...
        h = 0;
        for (k = g.length; h < k; ++h)
          (-1 === g[h].indexOf(":") ? "p0" : g[h].split(":")[0]) === t &&
            (f[g[h].split(":").pop()] =
              "featureMembers" == d ? Il(this.Cf, this) : Jl(this.Cf, this));
        r[e[t]] = f;
      }
      e = P([], r, a, c);
    }
  ...
  l.Cf = function (a, c) {
    var d, e;
    (e = a.getAttribute("fid")) ||
      (e = a.getAttributeNS("http://www.opengis.net/gml", "id") || "");
    var f = {},
      g;
    for (d = a.firstElementChild; d; d = d.nextElementSibling) {
      ...
      if (
        ...
        (1 === d.childNodes.length &&
          (3 === d.firstChild.nodeType || 4 === d.firstChild.nodeType))
      ) {
        var k = Cl(d, !1);
        Mo.test(k) && (k = void 0);
        f[h] = k;
  ...
  l.Jh = function (a, c) {
    ...
    a.getAttribute("srsDimension")
      ? (e = To(a.getAttribute("srsDimension")))
      : a.getAttribute("dimension")
      ? (e = To(a.getAttribute("dimension")))
      : f && (e = To(f));
  ...
  l.Oi = {
    "http://www.opengis.net/gml": { PolygonPatch: Jl(Zo.prototype.lo) },
  };
  l.Ti = {
    "http://www.opengis.net/gml": { LineStringSegment: Jl(Zo.prototype.eo) },
  };
  function $o(a, c, d) {
  ...
  var ap = {
    "http://www.opengis.net/gml": { lowerCorner: N(Vo), upperCorner: N(Vo) },
  };
  l = Zo.prototype;
  l.Yo = function (a, c, d) {
    var e = d[d.length - 1].srsName;
  ...
  l.Fe = function (a, c, d) {
    ...
    "Polygon" === a.nodeName || "PolygonPatch" === a.nodeName
      ? ((c = c.Qd()),
        Rl({ node: a, srsName: e }, bp, this.Si, c, d, void 0, this))
      : "Surface" === a.nodeName &&
        ((e = Bl(a.namespaceURI, "patches")),
        a.appendChild(e),
        (a = Bl(e.namespaceURI, "PolygonPatch")),
        e.appendChild(a),
        this.Fe(a, c, d));
  };
  l.Ae = function (a, c, d) {
    ...
    "LineString" === a.nodeName || "LineStringSegment" === a.nodeName
      ? ((e = Bl(a.namespaceURI, "posList")), a.appendChild(e), $o(e, c, d))
      : "Curve" === a.nodeName &&
        ((e = Bl(a.namespaceURI, "segments")),
        a.appendChild(e),
        (a = Bl(e.namespaceURI, "LineStringSegment")),
        e.appendChild(a),
        this.Ae(a, c, d));
  };
  l.zi = function (a, c, d) {
  ...
  l.De = function (a, c, d) {
    ...
    Array.isArray(c)
      ? e.dataProjection
        ? (g = ud(c, e.featureProjection, e.dataProjection))
        : (g = c)
      : (g = ho(c, !0, e));
  ...
  l.si = function (a, c, d) {
    ...
    for (m in h) {
      ...
      null !== n &&
        ...
        k.push(n),
        m == g || n instanceof vd
          ? m in e.Ac[f] || (e.Ac[f][m] = N(this.De, this))
          : m in e.Ac[f] || (e.Ac[f][m] = N(Vo)));
    }
    m = mb({}, e);
    m.node = a;
  ...
  var Bp = ["text", "type"],
    ...
    Kp = O(ip, {
      ...
      trkseg: Ll(
        N(function (a, c, d) {
          Rl(
            { node: a, geometryLayout: c.f, properties: {} },
            Ip,
            Jp,
            c.Z(),
            d
  ...
  var Np = O(ip, {
    ...
    wpt: N(function (a, c, d) {
      ...
      f.properties = c.P();
      if ((c = c.W()))
        (c = ho(c, !0, e)), (f.geometryLayout = c.f), Cp(a, c.Z(), d);
    }),
  });
  ...
  l.remove = function (a) {
    return Xp(this.a, a)
      ? (delete this.a[a], this.g--, this.b.length > 2 * this.g && Wp(this), !0)
      : !1;
  };
  function Wp(a) {
    if (a.g != a.b.length) {
  ...
  function aq(a, c, d) {
    if ("array" == ea(c))
      ...
      null != c &&
        d.push("&", a, "" === c ? "" : "=", encodeURIComponent(String(c)));
  }
  function bq(a, c) {
  ...
  function cq(a, c) {
    ...
    a instanceof cq
      ...
      ? ((this.c = !!c),
        ...
        fq(this, d[6] || "", !0),
        (this.f = gq(d[7] || "")))
      : ((this.c = !!c), (this.i = new hq(null, 0, this.c)));
  }
  cq.prototype.toString = function () {
    ...
    if ((d = this.b))
      this.a && "/" != d.charAt(0) && a.push("/"),
        a.push(iq(d, "/" == d.charAt(0) ? kq : lq, !0));
  ...
  function fq(a, c, d) {
    c instanceof hq
      ? ((a.i = c), nq(a.i, a.c))
      : (d || (c = iq(c, oq)), (a.i = new hq(c, 0, a.c)));
  }
  function pq(a) {
  ...
  function qq(a, c) {
    ...
    if (g) eq(f, e.o);
      ...
      if (
        ...
        for (
          var h = 0 == d.lastIndexOf("/", 0), d = d.split("/"), k = [], m = 0;
          m < d.length;
  ...
  l.toString = function () {
    ...
    for (var a = [], c = this.b.O(), d = 0; d < c.length; d++)
      for (
        var e = c[d], f = encodeURIComponent(String(e)), e = this.wc(e), g = 0;
        g < e.length;
        g++
      ) {
        var h = f;
  ...
  function Iq(a, c) {
    ...
    a.a &&
      (d = a.a.hd()) &&
      2 == d.length &&
      ((e[0] = (a.a.j * d[0]) / 2), (e[1] = (-a.a.j * d[1]) / 2), (f = "left"));
    if (pb(a.Ha()))
  ...
  function Xq(a, c) {
    ...
    if (e) {
      ...
      return "LineString" == f
        ? ((g = new T(null)), no(g, d), Zq(g, d), g)
        : "Polygon" == f
        ? ((g = new po(null)), ro(g, d), Zq(g, d), g)
  ...
  var gr = O(zq, { value: Jl(U) }),
    ...
    kr = O(
      zq,
      { href: L(Nq) },
      O(yq, { x: L(Qo), y: L(Qo), w: L(Qo), h: L(Qo) })
    ),
    lr = O(zq, {
      Icon: L(function (a, c) {
        var d = P({}, kr, a, c);
    ...
    ur = O(zq, { color: L(Lq), fill: L(No), outline: L(No) }),
    hr = O(zq, {
    ...
    dr = O(zq, {
      ...
      LineStyle: function (a, c) {
        var d = P({}, nr, a, c);
        d &&
          (c[c.length - 1].strokeStyle = new ik({
  ...
  l.oo = function (a, c) {
    ...
    if (null !== d) {
      var e = cr(a, c);
      e &&
        ((d = a.baseURI ? qq(a.baseURI, "#" + d).toString() : "#" + d),
        (this.b[d] = e));
    }
  };
  l.no = function (a, c) {
  ...
  l.jo = function (a) {
    ...
    El(a)
      ...
      : Fl(a)
      ? Za(c, yr(this, a))
      : "string" === typeof a && ((a = Gl(a)), Za(c, xr(this, a)));
    return c;
  };
  function xr(a, c) {
    var d,
  ...
  var Pr = O(zq, ["Document", "Placemark"]),
    ...
    Vr = O(
      zq,
      { href: N(Vo) },
      O(yq, { x: N(Wo), y: N(Wo), w: N(Wo), h: N(Wo) })
    ),
              ...
              m = {
                ...
                toString: function (a, c, e) {
                  ...
                  for (c = c || 0; c < e; c++) {
                    var g = this[c];
                    127 >= g
                      ? ((a += decodeURIComponent(f) + String.fromCharCode(g)),
                        (f = ""))
                      : (f += "%" + g.toString(16));
                  }
              ...
              g.write = function (a, c, e, f, g, q) {
                ...
                isNaN(c) || Infinity === c
                  ...
                  : ((f = Math.floor(Math.log(c) / Math.LN2)),
                    ...
                    (c = 1 <= f + w ? c + A / r : c + A * Math.pow(2, 1 - w)),
                    2 <= c * r && (f++, (r /= 2)),
                    f + w >= v
                      ? ((c = 0), (f = v))
                      : 1 <= f + w
                      ? ((c = (c * r - 1) * Math.pow(2, g)), (f += w))
                      : ((c = c * Math.pow(2, w - 1) * Math.pow(2, g)),
                        (f = 0)));
      ...
      })(
        {
          ...
          2: [
            function (a, c) {
              function g(a, c, e) {
                3 === a &&
                  ((a = new h(e, e.Ca() + e.ca)), a.length && (c[a.name] = a));
              }
          ...
          3: [
            function (a, c) {
              ...
              g.prototype.Og = function () {
                ...
                a.ca = this.Ke;
                for (
                  var c = a.Ca() + a.ca, e = 1, f = 0, g = 0, h = 0, v = [], w;
                  a.ca < c;

                )
                  if (
                    (f || ((f = a.Ca()), (e = f & 7), (f = f >> 3)),
                    f--,
                    1 === e || 2 === e)
                  )
                    (g += a.ud()),
        ...
        for (var n = 0, p = h.length; n < p; ++n) {
          if (g === al) {
            ...
            var w = q.type,
              A = void 0;
            1 === w
              ? (A = 1 === r.length ? "Point" : "MultiPoint")
              : 2 === w
              ? (A = 1 === r.length ? "LineString" : "MultiLineString")
              : 3 === w && (A = "Polygon");
            q = q.properties;
            q[this.a] = k;
            ...
            if (0 === A) A = null;
              ...
              var D = void 0;
              1 === A
                ? (D = 1 === q.length ? new E(null) : new oo(null))
                : 2 === A
                ? 1 === q.length
                  ? (D = new S(null))
                  : (D = new T(null))
    ...
    rs = O(os, {
      ...
      way: function (a, c) {
        for (
          ...
          Za(h, g.Sg[f.Lc[k]]);
        f.Lc[0] == f.Lc[f.Lc.length - 1]
          ? ((k = new F(null)), k.ba("XY", h, [h.length]))
          : ((k = new S(null)), k.ba("XY", h));
        ho(k, !1, d);
        d = new xl(k);
        d.hc(e);
        d.C(f.zd);
  ...
  ms.prototype.gc = function (a, c) {
    ...
    return "osm" == a.localName &&
      ((d = P({ Sg: {}, features: [] }, rs, a, [d])), d.features)
      ? d.features
      : [];
  };
  function ss(a) {
  ...
  var bt = {
    "http://www.opengis.net/gml": { boundedBy: L(Lo.prototype.te, "bounds") },
  };
  function at(a, c) {
    var d = {},
      ...
      "http://www.opengis.net/wfs": {
        ...
        Update: N(function (a, c, d) {
          ...
          if (void 0 !== f) {
            ...
            Rl({ node: a, srsName: e.srsName }, ht, Ml("Property"), h, d);
            gt(a, f);
          }
        }),
        ...
        Property: N(function (a, c, d) {
          ...
          void 0 !== c.value &&
            null !== c.value &&
            ((e = Bl("http://www.opengis.net/wfs", "Value")),
            a.appendChild(e),
            c.value instanceof vd
              ? Zo.prototype.De(e, c.value, d)
              : Vo(e, c.value));
        }),
    ...
    it = {
      "http://www.opengis.net/wfs": {
        Query: N(function (a, c, d) {
          ...
          if ((e = e.bbox))
            (h = Bl("http://www.opengis.net/ogc", "Filter")),
  ...
  Xs.prototype.l = function (a) {
    ...
    a &&
      (a.handle && c.setAttribute("handle", a.handle),
      a.outputFormat && c.setAttribute("outputFormat", a.outputFormat),
      void 0 !== a.maxFeatures && c.setAttribute("maxFeatures", a.maxFeatures),
      a.resultType && c.setAttribute("resultType", a.resultType),
      void 0 !== a.startIndex && c.setAttribute("startIndex", a.startIndex),
      void 0 !== a.count && c.setAttribute("count", a.count));
    c.setAttributeNS(
      "http://www.w3.org/2001/XMLSchema-instance",
      "xsi:schemaLocation",
      this.c
  ...
  var Jt = [null, "http://www.opengis.net/wms"],
    ...
    Ot = O(Jt, {
      ...
      BoundingBox: Kl(function (a) {
        var c = [
            Ro(a.getAttribute("minx")),
            Ro(a.getAttribute("miny")),
            Ro(a.getAttribute("maxx")),
            Ro(a.getAttribute("maxy")),
          ],
      ...
      MetadataURL: Kl(function (a, c) {
        var d = Ct(a, c);
        if (d) return (d.type = a.getAttribute("type")), d;
      }),
      DataURL: Kl(Ct),
  ...
  var au = [null, "http://www.opengis.net/wmts/1.0"],
    ...
    eu = O(
      ...
      O(bu, { SupportedCRS: L(U), Identifier: L(U) })
    ),
    ju = O(
      au,
      {
  ...
  l.Cl = function () {
    if (eh) {
      var a = this.Vg();
      a && void 0 === this.f
        ? (this.f = aa.navigator.geolocation.watchPosition(
            this.Sn.bind(this),
            this.Tn.bind(this),
            this.Fg()
          ))
        : a ||
          void 0 === this.f ||
          (aa.navigator.geolocation.clearWatch(this.f), (this.f = void 0));
    }
  };
  l.Sn = function (a) {
    a = a.coords;
  ...
  l.Ka = function (a) {
    ...
    return Qc(a, c)
      ? ((c = this.od()),
        (a[0] <= c[0] && a[2] >= c[0]) || (a[1] <= c[1] && a[3] >= c[1])
          ? !0
          : Ec(a, this.lg, this))
      : !1;
  };
  ...
  function nu(a, c, d) {
    for (
      ...
      (w = p.pop()),
        ...
        (t = a(D)),
        (v = c(t)),
        Na(v[0], v[1], h[0], h[1], k[0], k[1]) < d
          ? (e.push(k[0], k[1]), (g = A.toString()), (q[g] = !0))
          : (p.push(A, D, D, w), n.push(k, v, v, h), m.push(g, t, t, f));
    return e;
  }
  ...
  l.Kg = function (a) {
    ...
    k = 0;
    g.a &&
      ((g = g.G()), (k = Lc(g)), (d = d.focus[0]), d < g[0] || d > g[2]) &&
      ((k *= Math.ceil((g[0] - d) / k)),
    ...
    c.Qb(null, this.va);
    a = 0;
    for (f = this.b.length; a < f; ++a) (h = this.b[a]), c.dd(h, null);
    a = 0;
  ...
  vu.prototype.A = function () {
    void 0 === this.resolution &&
      (this.resolution = Mc(this.extent) / this.g.height);
    this.state = 2;
    this.c.forEach(sb);
    this.c = null;
    ji(this);
  ...
  vu.prototype.load = function () {
    0 == this.state &&
      ...
      ji(this),
      (this.c = [
        xb(this.g, "error", this.s, this),
        xb(this.g, "load", this.A, this),
      ]),
      this.j(this, this.o));
  };
  ...
  l.load = function () {
    0 == this.state &&
      ...
      Wf(this),
      (this.j = [
        xb(this.g, "error", this.El, this),
        xb(this.g, "load", this.Fl, this),
      ]),
      this.l(this, this.o));
  };
  function xu(a) {
  ...
  yu.prototype.setMap = function (a) {
    ...
    a &&
      ((a = this.target ? this.target : a.a),
      (this.a = [
        C(a, "drop", zu, this),
        C(a, "dragenter", Au, this),
        C(a, "dragover", Au, this),
        C(a, "drop", Au, this),
      ]));
  };
  var Cu = "addfeatures";
  ...
  function Eu(a) {
    return bj(a) && this.s(a)
      ? (le(a.map.aa(), 1), (this.a = this.c = void 0), !0)
      : !1;
  }
  function Hu(a, c) {
    Cb.call(this, a);
  ...
  function Ju(a) {
    return this.Di(a)
      ? ((this.ya = a.pixel), !0)
      : this.S
      ? ((this.ya = a.pixel), this.s || Tu(this, a), !0)
      : !1;
  }
  function Lu(a) {
    this.S = !1;
  ...
  function Su(a, c) {
    if (a.s) {
      ...
      a.c === Ou
        ? (f = a.a)
        : a.c === Nu
        ? ((f = a.a[0]), (f = f[f.length - 1]), Vu(a, c) && (d = a.s.slice()))
        : ((f = a.a), (f = f[f.length - 1]));
      f[0] = d[0];
      f[1] = d[1];
      a.H(a.a, e);
      a.D && a.D.W().ma(d);
      e instanceof F && a.c !== Nu
        ? (a.B || (a.B = new xl(new S(null))),
          (e = e.Ag(0)),
          (d = a.B.W()),
          d.ba(e.f, e.ga()))
        : a.T && ((d = a.B.W()), d.ma(a.T));
      Wu(a);
  ...
  function Vu(a, c) {
    ...
    if (a.l) {
      ...
      a.c === Pu
        ...
        : a.c === Nu &&
          ((e = a.a[0].length > a.Ua),
          (f = [a.a[0][0], a.a[0][a.a[0].length - 2]]));
      if (e)
  ...
  function Tu(a, c) {
    ...
    a.c === Ou
      ? (a.a = d.slice())
      : a.c === Nu
      ? ((a.a = [[d.slice(), d.slice()]]), (a.T = a.a[0]))
      : ((a.a = [d.slice(), d.slice()]), a.c === Uu && (a.T = a.a));
  ...
  l.to = function () {
    var a = this.l.W(),
      ...
      d;
    this.c === Pu
      ? ((c = this.a), c.splice(-2, 1), this.H(c, a))
      : this.c === Nu &&
        ((c = this.a[0]),
        c.splice(-2, 1),
        (d = this.B.W()),
  ...
  l.ed = function () {
    ...
    "MultiPoint" === this.Y
      ? a.Ra(new oo([c]))
      : "MultiLineString" === this.Y
      ? a.Ra(new T([c]))
      : "MultiPolygon" === this.Y && a.Ra(new po([c]));
  ...
  l.hm = function (a, c) {
    ...
    for (g = d.length; f < g; ++f)
      (e = d[f]),
        (e = { feature: a, geometry: c, depth: [f], index: f, ka: [e, e] }),
        this.a.Aa(c.G(), e);
  };
  l.dh = function (a, c) {
    var d = c.Z(),
    ...
    for (f = d.length - 1; e < f; ++e)
      (g = d.slice(e, e + 2)),
        (h = { feature: a, geometry: c, index: e, ka: g }),
        this.a.Aa(nc(g), h);
  };
  l.gm = function (a, c) {
    var d = c.Z(),
    ...
    for (k = d.length; h < k; ++h)
      for (e = d[h], f = 0, g = e.length - 1; f < g; ++f)
        (m = e.slice(f, f + 2)),
          (n = { feature: a, geometry: c, depth: [h], index: f, ka: m }),
          this.a.Aa(nc(m), n);
  };
  l.km = function (a, c) {
    var d = c.Z(),
    ...
    for (n = d.length; m < n; ++m)
      for (p = d[m], h = 0, k = p.length; h < k; ++h)
        for (e = p[h], f = 0, g = e.length - 1; f < g; ++f)
          (q = e.slice(f, f + 2)),
            (r = { feature: a, geometry: c, depth: [h, m], index: f, ka: q }),
            this.a.Aa(nc(q), r);
  };
  l.fm = function (a, c) {
    var d,
    ...
    if (c) {
      ...
      for (var g = 0, h = e.length; g < h; ++g) {
        ...
        if (Vb(m[0], c) && !f[n][0]) this.l.push([k, 0]), (f[n][0] = k);
          ...
          if (
            ("LineString" !== k.geometry.X() &&
              "MultiLineString" !== k.geometry.X()) ||
            !f[n][0] ||
            0 !== f[n][0].index
          )
  ...
  function bv(a) {
    ...
    a.map.aa().f.slice()[1] ||
      a.type != $h ||
      this.N ||
      ((this.ya = a.pixel), ev(this, a.pixel, a.map));
    if (this.c && this.ta(a))
        ...
        for (k = c.length - 1; 0 <= k; --k)
          if (
            ...
            q &&
              ...
              this.a.Aa(nc(f.ka), f),
              kv(this, h, m, p.depth, -1),
              this.c && (this.S.ea().mb(this.c), (this.c = null)));
          }
        c = !0;
    ...
    if (0 < g.length) {
      ...
      if (Math.sqrt(Xb(c, m)) <= a.D) {
        ...
        for (m = g.length; c < m; ++c)
          if (
            ((k = g[c].ka),
            (Vb(h[0], k[0]) && Vb(h[1], k[1])) ||
              (Vb(h[0], k[1]) && Vb(h[1], k[0])))
          )
            d[x(k)] = !0;
          else break;
        a.oa = d;
  ...
  l.bl = function (a, c) {
    for (
      var d = a.ka, e = a.feature, f = a.geometry, g = a.depth, h = a.index, k;
      c.length < f.ra();
  ...
  function kv(a, c, d, e, f) {
    em(a.a, c.G(), function (a) {
      a.geometry === c &&
        (void 0 === e || void 0 === a.depth || bb(a.depth, e)) &&
        a.index > d &&
        (a.index += f);
    });
  }
  ...
  function nv(a) {
    ...
    if (f)
      g.fd(
        ...
        (0 < m.length && 1 == h.Zb() && h.item(0) == m[0]) ||
          ((n = !0),
          0 !== h.Zb() && ((k = Array.prototype.concat(h.a)), h.clear()),
          h.jf(m),
          0 === m.length
            ? nb(this.a)
            : 0 < k.length &&
        ...
        function (a, f) {
          if (this.o(a, f)) {
            if ((!c && !e) || Wa(h.a, a))
              (d || e) &&
                Wa(h.a, a) &&
                (k.push(a), (g = x(a)), delete this.a[g]);
            else {
              m.push(a);
              var g = x(a);
              this.a[g] = f;
  ...
  l.tb = function (a, c) {
    ...
    if (f) {
      ...
      f.call(this, a, e);
      d &&
        ((this.D[g] = C(e, "change", this.Ak.bind(this, a), this)),
        (this.H[g] = C(a, Mb(a.a), this.pm, this)));
    }
  };
  l.zj = function (a) {
    this.tb(a);
  ...
  l.setMap = function (a) {
    ...
    a &&
      (this.l
        ? d.push(
            C(this.l, "add", this.eh, this),
            C(this.l, "remove", this.fh, this)
          )
        : this.s &&
          d.push(
            C(this.s, "addfeature", this.eh, this),
            C(this.s, "removefeature", this.fh, this)
          ),
      e.forEach(this.zj, this));
  };
  l.Dc = Uc;
  l.ni = function (a) {
    this.mb(a, !1);
  ...
  function vv(a) {
    ...
    return !this.a && this.l
      ? ((this.a = a.coordinate),
        xv.call(this, a),
        this.b(new tv("translatestart", this.c, a.coordinate)),
        !0)
      : !1;
  }
  function yv(a) {
    return this.a
      ? ((this.a = null),
        xv.call(this, a),
        this.b(new tv("translateend", this.c, a.coordinate)),
        !0)
      : !1;
  }
  function wv(a) {
    ...
    this.c(
      function (a) {
        ...
        var c = (255 * a) | 0,
          d = this.S[c];
        d ||
          ((d = [new lk({ image: new xi({ opacity: a, src: this.T }) })]),
          (this.S[c] = d));
        return d;
      }.bind(this)
    );
  ...
  function Cv(a, c, d, e, f, g, h, k, m, n, p) {
    ...
    if (0 === Jc(g)) this.state = 4;
      ...
      ((this.A = new kl(a, d, g, f, e * (void 0 !== n ? n : 0.5))),
      0 === this.A.f.length)
    )
      this.state = 4;
    else if (
      ...
      f &&
        (a.a
          ? ((d[1] = La(d[1], f[1], f[3])), (d[3] = La(d[3], f[1], f[3])))
          : (d = Pc(d, f))),
      Jc(d))
    )
      if (
        ((a = dg(c, d, this.o)), 100 > (a.wa - a.ua + 1) * (a.Ba - a.za + 1))
      ) {
        for (c = a.ua; c <= a.wa; c++)
          for (d = a.za; d <= a.Ba; d++)
  ...
  l.eb = function (a) {
    var c = this.f;
    return !this.tileGrid || (c && !qd(c, a))
      ? ((c = x(a).toString()), c in this.l || (this.l[c] = jg(a)), this.l[c])
      : this.tileGrid;
  };
  l.ld = function (a) {
    var c = this.f;
  ...
  Gv.prototype.s = function (a) {
    if (
      ...
      this.tileGrid = f;
      var g = this.o;
      this.tileUrlFunction = tm(
        d.imageUrlSubdomains.map(function (a) {
          var c = [0, 0, 0],
            e = d.imageUrl.replace("{subdomain}", a).replace("{culture}", g);
          return function (a) {
            if (a)
              return (
                ue(a[0], a[1], -a[2] - 1, c), e.replace("{quadkey}", ve(c))
              );
          };
        })
      );
  ...
  function Mv(a) {
    if (void 0 !== a.B) {
      a.A.length = 0;
      for (
        var c = oc(), d = a.oa * a.B, e = a.s.je(), f = {}, g = 0, h = e.length;
        g < h;
        g++
      ) {
        var k = e[g];
              ...
              m.prototype.Zf = function () {
                if (0 === this.Gd && 0 < this.Vc.length) {
                  ...
                  if (1 === g)
                    ...
                    for (
                      var h = 4 * Math.ceil(a.xc[0].data.length / 4 / g), k = 0;
                      k < g;
                      ++k
                    ) {
                      for (
                        var m = k * h, n = [], B = 0, J = f.length;
                        B < J;
                        ++B
                      )
  ...
  Zv.prototype.oa = function (a, c, d, e, f) {
    d
      ? c(d)
      : e &&
        (this.b(new dw(fw, a, f)),
        bw(this, a.extent, a.viewState.resolution / a.pixelRatio) ||
          this.i.putImageData(e, 0, 0),
        c(null));
  };
  var cw = null;
  function aw(a) {
  ...
  function $v(a) {
    for (var c = a.length, d = Array(c), e = 0; e < c; ++e) {
      var f = e,
        ...
        h = null;
      g instanceof ng
        ? ((g = new Xj({ source: g })), (h = new pm(g)))
        : g instanceof pl && ((g = new Wj({ source: g })), (h = new om(g)));
      d[f] = h;
    }
    return d;
  }
    ...
    if (!(e.Kb().length <= a[0])) {
      ...
      h
        ? ((d = d.kb.split(":").pop()),
          ...
          (e.BBOXSR = d),
          (e.IMAGESR = d),
          (e.DPI = Math.round(e.DPI ? e.DPI * c : 90 * c)),
          (a = (1 == h.length ? h[0] : h[Qa((a[1] << a[0]) + a[2], h.length)])
  ...
  l.yj = function (a, c, d, e, f) {
    this.tileGrid
      ? ((c = this.tileGrid.Ud(a, c)),
        pw(this.Lb(c[0], c[1], c[2], 1, this.f), a, d, e, f))
      : !0 === f
      ? Ig(function () {
          d.call(e, null);
        })
  ...
  l.getData = function (a) {
    ...
    var c =
      this.c[
        Math.floor(
          (1 - (a[1] - this.g[1]) / (this.g[3] - this.g[1])) * this.c.length
        )
      ];
    if ("string" !== typeof c) return null;
    a = c.charCodeAt(
      Math.floor(((a[0] - this.g[0]) / (this.g[2] - this.g[0])) * c.length)
    );
    93 <= a && a--;
    35 <= a && a--;
    a -= 32;
  ...
  function ww(a, c, d, e, f, g, h) {
    ...
    if (k) {
      ...
      h.BBOX = e.join(",");
      return $p(
        bq([1 == k.length ? k[0] : k[Qa((c[1] << c[0]) + c[2], k.length)]], h)
      );
    }
  }
  l.Yb = function (a) {
  ...
  function Aw(a) {
    ...
    var c = a.size,
      ...
      g = 256;
    switch (
      void 0 !== a.tierSizeCalculation ? a.tierSizeCalculation : "default"
    ) {
      case "default":
        for (; d > g || e > g; )
  ...
  function Ew(a, c, d, e, f, g, h) {
    ...
    for (p = k.length; n < p; ++n) {
      ...
      m ||
        n !== p - 1 ||
        (c
          ? ((m = Math.min(2 * a.f, a.g)), (a.f = m))
          : ((m = Math.min(2 * a.a, a.g)), (a.a = m)),
        (m = new Dw(m, a.b)),
        k.push(m),
        ++p);
    }
  ...
  Dw.prototype.add = function (a, c, d, e, f) {
    ...
    for (k = this.a.length; h < k; ++h)
      if (((g = this.a[h]), g.width >= c + this.b && g.height >= d + this.b))
        return (
          (k = { offsetX: g.x + this.b, offsetY: g.y + this.b, image: this.g }),
          (this.f[a] = k),
  ...
  l.Ch = function (a, c, d, e) {
    ...
    for (d = 0; d <= this.b; d++)
      (e = (2 * d * Math.PI) / this.b - Math.PI / 2 + this.o),
  ...
  l.Bh = function (a, c, d, e) {
    ...
    var f;
    for (d = 0; d <= this.b; d++)
      (f = (2 * d * Math.PI) / this.b - Math.PI / 2 + this.o),
  ...
  u(
    ...
    function (a, c) {
      ...
      var k = {};
      "Dimension" in d &&
        d.Dimension.forEach(function (a) {
          var c = a.Identifier,
            d = a.Default;
      ...
      void 0 !== p &&
        ...
        (r = p[0] == r[0] && p[2] == r[2]),
        (q = ud(p, "EPSG:4326", n)),
        (p = n.G()) && (wc(p, q) || (q = void 0)));
      var m = yw(m, q),
        t = [];
      q = c.requestEncoding;
      q = void 0 !== q ? q : "";
      if (
        a.hasOwnProperty("OperationsMetadata") &&
        a.OperationsMetadata.hasOwnProperty("GetTile") &&
        0 !== q.indexOf("REST")
      )
        for (
          var d = a.OperationsMetadata.GetTile.DCP.HTTP.Get,
            p = 0,
            v = d.length;
          p < v;
          ++p
